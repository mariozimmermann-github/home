...
@ 010,005 LISTBOX oKarEnde Var cModelo FIELDS HEADER; 
	 ...
	 "Saldo" ,;   
	 "Num.Seq.",;
	 "Num.Serie" FIELDSIZES 25,30,15,32,50,40,40,40,40,40 SIZE 467,215 ON DBLCLICK () PIXEL OF oFolder:aDialogs[11]
...
DEFINE MSDIALOG oDlgSDB TITLE "Ajuste no SDB"  OF oDlgSDB PIXEL FROM 010,010 TO 340,335 
DEFINE FONT oBold   NAME "Arial" SIZE 0, -12 BOLD
...
@ 144,005 SAY "Num. Serie"                              SIZE 040,10 PIXEL OF oDlgSDB FONT oBold 
@ 140,043 MSGET oVar   VAR cNumSer  Picture "@!"        SIZE 050,10 PIXEL OF oDlgSDB When lVisQuant
                                                      //fAjusta(cOpcao,cLoteCtl,cDoc,dData,nQuant,cEndereco,cNumSeq,cTipoMov,cNumLote,cSerie,cCliFor,cLoja)
IF cOpcao $ "DB_I" //Incluir                                                                                                   
   @ 160,005 BUTTON "&Entrada" SIZE 25,14 PIXEL ACTION (fAjusta(cOpcao,cLoteCtl,cDoc,dData,nQuant,cLocaliz,cNumSeq,"499"   ,cNumLote,cSerie,cCliFor,cLoja,,cFolder),oDlgSDB:End())
   @ 160,040 BUTTON "&Saida"   SIZE 25,14 PIXEL ACTION (fAjusta(cOpcao,cLoteCtl,cDoc,dData,nQuant,cLocaliz,cNumSeq,"999"   ,cNumLote,cSerie,cCliFor,cLoja,,cFolder,cNumSer),oDlgSDB:End())
   @ 160,075 BUTTON "&Transf." SIZE 25,14 PIXEL ACTION (fAjusta(cOpcao,cLoteCtl,cDoc,dData,nQuant,cLocaliz,cNumSeq,"499/999",cNumLote,cSerie,cCliFor,cLoja,,cFolder),oDlgSDB:End())  
   @ 160,110 BUTTON "&Sair"    SIZE 25,14 PIXEL ACTION oDlgSDB:End()  
Else
   @ 160,050 BUTTON "&Confirmar" SIZE 30,14 PIXEL ACTION (fAjusta(cOpcao,cLoteCtl,cDoc,dData,nQuant,cLocaliz,cNumSeq,Nil   ,cNumLote,cSerie,cCliFor,cLoja,,cFolder),oDlgSDB:End())
   @ 160,090 BUTTON "&Sair"      SIZE 30,14 PIXEL ACTION oDlgSDB:End()
Endif
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Static Function fAjusta(cOpcao,cLoteCtl,cDoc,dData,nQuant,cEndereco,cNumSeq,cTipoMov,cNumLote,cSerie,cCliFor,cLoja,dDtValid,cFolder,cNumSer)
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Local aArea  := GetArea()
